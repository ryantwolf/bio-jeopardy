...
var t104 = new tile("A solution where water is moving in equal amounts in and out of a cell. (Do NOT include solution in answer)", "isotonic", 1000, "104");
...
function checkAnswer() {
	...
	if (answer.toUpperCase() === currentTile.answer.toUpperCase()) {
		...
		score += currentTile.points;
		document.getElementById("sSlot").innerHTML = "Score: " + score;
